...
<% 	Connection con = DBM.getConn();
    ...
    String sql1 = "select sum(amount) from transactions where MONTH(date)=? And senderAccount in (select accountnumber from account where userid= ?)";
    String sql2 = "select sum(amount) from transactions where MONTH(date)=? And receiverAccount in (select accountnumber from account where userid= ?)";
