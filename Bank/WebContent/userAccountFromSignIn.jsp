...
String sessionStrId = session.getAttribute("userid").toString();
int sessionId = Integer.parseInt(sessionStrId);
String sql = "select * from account where userid = " + sessionId;
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span1">
                                        <span class="line"></span>Account Number
                                    </th>
                                    <th class="span2">
                            ...
                            %>
                                ...
                                <tr class="first">
                                    ...
                                    <td>
                                        <a href="userTransactionFromSignIn.jsp?accountNum=<%=rs.getInt(1) %>"><%=rs.getInt(1) %>
                                    </td>
                                    <td>
