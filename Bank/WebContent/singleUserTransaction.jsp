...
//int sessionId = Integer.parseInt(strSession);
...
PreparedStatement prestate = DBM.getPreState(conn,sql);
prestate.setInt(1,accountNum);
prestate.setInt(2,accountNum);
                            ...
                            <div class="dialog">
                                ...
                                <div class="body">
                                    ...
                                    <div class="form">
                                        ...
                                        <a class="btn-flat small">Apply</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            <a class="btn-flat new-product">+ Add Transaction</a>
                        </div>
                    </div>
